...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const chorltonAutoPages: MetadataRoute.Sitemap = [
    ...
    // Didsbury pillar + spoke cluster
    { url: `${baseUrl}/auto-locksmith-didsbury`, priority: 0.9 },
    { url: `${baseUrl}/car-lockout-didsbury`, priority: 0.85 },
    { url: `${baseUrl}/car-key-replacement-didsbury`, priority: 0.85 },
    { url: `${baseUrl}/lost-car-keys-didsbury`, priority: 0.85 },
    { url: `${baseUrl}/van-locksmith-didsbury`, priority: 0.85 },
    { url: `${baseUrl}/24-hour-auto-locksmith-didsbury`, priority: 0.85 },
    { url: `${baseUrl}/car-key-programming-didsbury`, priority: 0.85 },
    { url: `${baseUrl}/ignition-repair-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/car-key-fob-repair-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/spare-car-key-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/mobile-auto-locksmith-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/broken-car-key-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/van-key-replacement-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/ignition-replacement-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/key-stuck-in-ignition-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/car-key-repair-didsbury`, priority: 0.8 },
    { url: `${baseUrl}/cheap-auto-locksmith-didsbury`, priority: 0.8 },
  ].map((page) => ({
    ...page,
    lastModified,
    changeFrequency: 'monthly' as const,
